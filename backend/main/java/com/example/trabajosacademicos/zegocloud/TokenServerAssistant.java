package com.example.trabajosacademicos.zegocloud;
...
public class TokenServerAssistant {
     ...
     */
    static final public String PrivilegeKeyLogin = "1";
    static final public String PrivilegeKeyPublish = "2";

    /**
     * Definition of privilege switches.
     */
    static final public int PrivilegeEnable = 1;
    static final public int PrivilegeDisable = 0;
